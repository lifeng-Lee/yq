...
[task_local]
#早起福利
30 6 * * * jd_goodMorning.js, tag=早起福利, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true

====================Loon=================
[Script]
cron "30 6 * * *" script-path=jd_goodMorning.js,tag=早起福利

===================Surge==================
早起福利 = type=cron,cronexp="30 6 * * *",wake-system=1,timeout=3600,script-path=jd_goodMorning.js

============小火箭=========
早起福利 = type=cron,script-path=jd_goodMorning.js, cronexpr="30 6 * * *", timeout=3600, enable=true
 */
const $ = new Env("早起福利")
