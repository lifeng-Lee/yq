...
[task_local]
#推推赚大钱
0 0,2,22 * * * jd_ttzdq.js, tag=推推赚大钱, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "0 0,2,22 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_ttzdq.js,tag=推推赚大钱

===============Surge=================
推推赚大钱 = type=cron,cronexp="0 0,2,22 * * *",wake-system=1,timeout=3600,script-path=jd_ttzdq.js

============小火箭=========
推推赚大钱 = type=cron,script-path=jd_ttzdq.js, cronexpr="0 0,2,22 * * *", timeout=3600, enable=true
 */
const $ = new Env('推推赚大钱');
