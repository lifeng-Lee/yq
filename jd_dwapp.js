...
[task_local]
#积分换话费
33 5,17 * * * jd_dwapp.js, tag=积分换话费, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "33 5,17 * * *" script-path=jd_dwapp.js, tag=积分换话费

====================Surge================
积分换话费 = type=cron,cronexp="33 5,17 * * *",wake-system=1,timeout=3600,script-path=jd_dwapp.js

============小火箭=========
积分换话费 = type=cron,script-path=jd_dwapp.js, cronexpr="33 5,17 * * *", timeout=3600, enable=true
 */
const $ = new Env('积分换话费');
