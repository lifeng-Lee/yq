...
[task_local]
#美丽研究院
1 7,12,19 * * * jd_beauty.js, tag=美丽研究院, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "1 7,12,19 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_beauty.js,tag=美丽研究院

===============Surge=================
美丽研究院 = type=cron,cronexp="1 7,12,19 * * *",wake-system=1,timeout=3600,script-path=jd_beauty.js

============小火箭=========
美丽研究院 = type=cron,script-path=jd_beauty.js, cronexpr="1 7,12,19 * * *", timeout=3600, enable=true
 */
const $ = new Env('美丽研究院');
