...
[task_local]
#领券中心签到
10 0 * * * jd_ccSign.js, tag=领券中心签到, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "10 0 * * *" script-path=jd_ccSign.js,tag=领券中心签到

===============Surge=================
领券中心签到 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=3600,script-path=jd_ccSign.js

============小火箭=========
领券中心签到 = type=cron,script-path=jd_ccSign.js, cronexpr="10 0 * * *", timeout=3600, enable=true
 */
