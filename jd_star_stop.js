...
[task_local]
#明星小店
10 9,18 9-25 8 * jd_star_shop.js, tag=明星小店, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "10 9,18 9-25 8 *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_star_shop.js,tag=明星小店

===============Surge=================
明星小店 = type=cron,cronexp="10 9,18 9-25 8 *",wake-system=1,timeout=3600,script-path=jd_star_shop.js

============小火箭=========
明星小店 = type=cron,script-path=jd_star_shop.js, cronexpr="10 9,18 9-25 8 *", timeout=3600, enable=true
 */
const $ = new Env('明星小店');
