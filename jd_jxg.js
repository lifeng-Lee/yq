...
[task_local]
#京小鸽吾悦寄
8 4,11 * * * jd_jxg.js, tag=京小鸽吾悦寄, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "8 4,11 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jxg.js,tag=京小鸽吾悦寄

===============Surge=================
京小鸽吾悦寄 = type=cron,cronexp="8 4,11 * * *",wake-system=1,timeout=3600,script-path=jd_jxg.js

============小火箭=========
京小鸽吾悦寄 = type=cron,script-path=jd_jxg.js, cronexpr="8 4,11 * * *", timeout=3600, enable=true
 */
