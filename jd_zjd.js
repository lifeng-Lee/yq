...
[task_local]
#赚京豆
5 2,3 * * * jd_zjd.js, tag=赚京豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "5 2,3 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_zjd.js,tag=赚京豆

===============Surge=================
赚京豆 = type=cron,cronexp="5 2,3 * * *",wake-system=1,timeout=3600,script-path=jd_zjd.js

============小火箭=========
赚京豆 = type=cron,script-path=jd_zjd.js, cronexpr="5 2,3 * * *", timeout=3600, enable=true
 */
const $ = new Env('赚京豆');
