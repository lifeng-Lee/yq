/*
小鸽有礼-每日抽奖
活动入口：京喜APP-我的-小鸽有礼-每日抽奖
============Quantumultx===============
[task_local]
#小鸽有礼-每日抽奖
21 2,15,19 * * * jd_daily_lottery.js, tag=小鸽有礼-每日抽奖, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "21 2,15,19 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_daily_lottery.js,tag=小鸽有礼-每日抽奖

===============Surge=================
小鸽有礼-每日抽奖 = type=cron,cronexp="21 2,15,19 * * *",wake-system=1,timeout=3600,script-path=jd_daily_lottery.js

============小火箭=========
小鸽有礼-每日抽奖 = type=cron,script-path=jd_daily_lottery.js, cronexpr="21 2,15,19 * * *", timeout=3600, enable=true
 */
